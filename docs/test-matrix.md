...
| deepseek-quality-modes | llm-provider | visual-report-redesign 3.4 | `src/lib/config/providers.ts`, `src/components/workbench/reading-step.tsx` | `src/tests/unit/provider-config.test.ts`, `src/tests/e2e/generate-report.spec.ts` | Unit + E2E | Added |
